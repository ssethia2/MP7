public class Board {
	 ...
	 */
	/*
	 * public String checkBoardForComp(final int x, final int y) { if
	 * (this.gameBoard[x][y] == null) { return "Computer missed!"; } else { if
	 * (this.gameBoard[x][y].hitShip()) { return "Computer sank ship " +
	 * this.gameBoard[x][y].getName(); } return "Computer hit ship " +
	 * this.gameBoard[x][y].getName(); } }
	 */
